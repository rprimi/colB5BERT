...
t1 <- psych::corr.test(dataset_test2_wide[ , 9:106], dataset_test2_wide[ , 3:8]) %>% .$r 
t1b <- as.data.frame(t1) %>% mutate(vars = dimnames(t1)[[1]])
writexl::write_xlsx(t1b , path="../data/results.xlsx")
...
t2 <- psych::corr.test(dataset_test2_wide_subj[ , 9:106], dataset_test2_wide_subj[ , 3:8]) %>% .$r 
t2b <- as.data.frame(t2) %>% mutate(vars = dimnames(t2)[[1]])
writexl::write_xlsx(t2b , path="../data/results2.xlsx")
